...
DPR_CP_PATH = "/home/pavel/code/DPR/output/dpr_biencoder.31.1416"


final_encoder_ctx, final_encoder_question = load_bi_encoders(DPR_CP_PATH, args)

convert_roberta_checkpoint_to_pytorch(final_encoder_ctx, "./models/encoder_ctx", False)
convert_roberta_checkpoint_to_pytorch(final_encoder_question, "./models/encoder_question", False)